            ...
            <main className="max-w-7xl mx-auto px-6 pt-24 pb-32 text-center relative z-10">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-text-secondary max-w-3xl mx-auto mb-12 leading-relaxed">
                        The premium analytics platform for structural economic analysis. Transform complex data into clear, actionable insights powered by cutting-edge visualizations.
                    </p>
                ...
                >
                    <div className="glass-card p-8">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                            Explore macro-economic trends across continents with our interactive global explorer.
                        </p>
                    </div>
                    <div className="glass-card p-8 relative overflow-hidden group">
                        ...
                        <p className="text-text-secondary leading-relaxed relative z-10">
                            Granular breakdowns of income deciles utilizing sophisticated machine learning models.
                        </p>
                    </div>
                    <div className="glass-card p-8">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                            SOC2 compliant infrastructure with seamless Power BI and Tableau integration.
                        </p>
                    </div>
                </motion.div>
            </main>
